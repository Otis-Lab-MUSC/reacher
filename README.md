...
### Using `curl`
```python
curl -L -o reacher-1.0.1-py3-none-any.whl https://github.com/Otis-Lab-MUSC/REACHER/releases/download/v1.0.1-beta/reacher-1.1.1-py3-none-any.whl
python -m pip install reacher-1.1.1-py3-none-any.whl
```
### Using `wget`
```python
wget https://github.com/Otis-Lab-MUSC/REACHER/releases/download/v1.0.1-beta/reacher-1.1.1-py3-none-any.whl
python -m pip install reacher-1.1.1-py3-none-any.whl
```
