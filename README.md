...
[![Version](https://img.shields.io/badge/version-3.0.0--beta.7-blue)](https://github.com/Otis-Lab-MUSC/reacher/releases)
...
```bash
pip install reacher2p-3.0.0b7-py3-none-any.whl
```
