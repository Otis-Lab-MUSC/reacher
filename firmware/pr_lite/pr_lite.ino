...
DeviceSet devices = { &rLever, &lLever, &cue, &cue2, &pump, &pump2, &lickCircuit, &laser, nullptr, nullptr };
...
void SendIdentification() {
  Serial.println(F("{\"level\":\"000\",\"device\":\"CONTROLLER\",\"sketch\":\"pr_lite.ino\",\"version\":\"v3.4.0-alpha.10\",\"baud_rate\":115200,\"schedule\":\"PROGRESSIVE_RATIO\"}"));
}
